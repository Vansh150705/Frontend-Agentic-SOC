...
export const DashboardPage = () => {
  ...
  const { alerts: recentAlerts, loading, error } = useAlertsData();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200">
        ...
        {loading && (
          <p className="px-5 py-4 text-slate-400 text-xs">Loading alerts…</p>
        )}
        {error && (
          <p className="px-5 py-4 text-red-500 text-xs">Failed to load alerts: {error}</p>
        )}
